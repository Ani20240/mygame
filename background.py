...
background_sprites = {
    "T": pygame.image.load(""),
    "M": pygame.image.load("images/lava_middle.png"),
    "B": pygame.image.load("images/lava_bottom.png"),
    "S": pygame.image.load("images/sky.png"),
    "I": pygame.image.load("images/island.png"),
    "W": pygame.image.load("images/water.png")
}
...
level_map = [
    ...
    "MMMMMMMMMMMTMMMMMWWW",
    "BBBBBBBBBBBTBBBBBTTT"
]
...
class Background(pygame.sprite.Sprite):
    ...
    def collision(self):
        if self.name in ["T", "M", "B"] and self.rect.colliderect(player.rect):
            player.gravity = False
            player.rect.bottom = self.rect.top

        if self.name in ["S", "I", "W"] and self.rect.colliderect(player.rect):
            player.gravity = True
